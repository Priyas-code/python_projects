#Create card class(for what we actually use for game or base )
#give card verities(suit) , rank ,value  (for comapirasion)
# access them through instance
...
#random library shuffle() function used
#deal cards from the deck object
#pop methods from cards list
...
def hit(deck,hand):    # function taking hits anytime
...
#function to end of game scenarious
